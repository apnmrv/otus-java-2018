...
/**
 *
 * Homework L01.1 done for Otus Java Developer Course
 *
 * To start the application:
 * mvn package
 * java -cp ./target/L01.1-settings.jar ru.otus.l011.Main
 * java -jar ./target/L01.1-settings.jar //java.lang.NoClassDefFoundError: com/google/common/collect/Lists
 * java -cp ./target/L01.1-settings.jar;/home/USERNAME/.m2/repository/com/google/guava/guava\23.0\guava-23.0.jar ru.otus.l011.Main
 *
 * To unzip the jar:
